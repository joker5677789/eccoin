...
int64 nChainStartTime = 1603962620;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CBigNum vector ECCOIN empty mapBlockIndex ECCOIN ECCOIN";
        CTransaction txNew;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        assert(block.hashMerkleRoot == uint256("0x0891bfff72525722bfc7b7fc33ea75a5eb124a52ea9816192df58de23002d534"));
...
string GetWarnings(string strFor)
{
    ...
    if (Checkpoints::IsSyncCheckpointTooOld(100 * 60 * 60 * 24 * 365) && !fTestNet && !IsInitialBlockDownload())
    {
        nPriority = 100;
